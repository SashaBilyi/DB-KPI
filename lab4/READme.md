...
[cite_start]Цей документ містить аналітичні SQL-запити (OLAP), розроблені для бази даних "Система лікарняних записів", та пояснення до кожного з них.
...
[cite_start]Підраховує загальну кількість пацієнтів у базі даних.
```sql
